...
<!-- Container wrapper -->
  ...
  <table class="table align-middle mb-0 bg-white text-center pt-3">
    <thead class="head">
            ...
            <tbody>
              <?php
              $sql = "SELECT * FROM logkaryawan";
              $query = mysqli_query($db, $sql);
        
              while($logkaryawan = mysqli_fetch_array($query)){
                echo "<tr>";
        
                echo "<td>".$logkaryawan['id_log']."</td>";
                echo "<td>".$logkaryawan['id_karyawan']."</td>";
                echo "<td>".$logkaryawan['alamat_lama']."</td>";
                echo "<td>".$logkaryawan['alamat_baru']."</td>";
