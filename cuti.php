    ...
    <thead class="head">
            ...
            <tbody>
              ...
              while($cuti = mysqli_fetch_array($query)){
                ...
                echo "<td>".$cuti['id_karyawan']."</td>";
                echo "<td>".$cuti['tanggal_cuti']."</td>";
                echo "<td>".$cuti['jumlah']."</td>";
                echo "<td>";
                echo "<a href='hapuscuti.php?id_cuti=".$cuti['id_cuti']."'><button>Hapus</button></a>";
                echo "</td>";
          ...
          <center>
  <br><a href="tmbhcuti.php"><button>tambah cuti</button></a></br>
