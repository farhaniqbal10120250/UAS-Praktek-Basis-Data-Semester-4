...
<!-- Container wrapper -->
  ...
  <table class="table align-middle mb-0 bg-white text-center pt-3">
    <thead class="head">
            ...
            <tbody>
            <?php
        $sql = "SELECT gaji.id_gaji, gaji.tanggal, gaji.keterangan, gaji.jumlah_gaji, gaji.jumlah_lembur, gaji.total_gaji, karyawan.nama, gaji.jumlah_cuti
        FROM gaji, karyawan
        ...
        while($gaji= mysqli_fetch_array($query)){
            ...
            echo "<td>".$gaji['id_gaji']."</td>";
            echo "<td>".$gaji['tanggal']."</td>";
            echo "<td>".$gaji['keterangan']."</td>";
            echo "<td>".$gaji['jumlah_gaji']."</td>";
            echo "<td>".$gaji['jumlah_lembur']."</td>";
            echo "<td>".$gaji['total_gaji']."</td>";
            echo "<td>".$gaji['nama']."</td>";
            echo "<td>".$gaji['jumlah_cuti']."</td>";
            echo "<td>";
            echo "<a href='hapusgaji.php?id_gaji=".$gaji['id_gaji']."'><button>Hapus</button></a>";
            echo "</td>";
            echo "</tr>";
        }
        ?>
          ...
          <center>
  <br><a href="tmbhgaji.php"><button>tambah gaji</button></a></br>
